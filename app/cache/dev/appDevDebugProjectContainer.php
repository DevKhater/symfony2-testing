...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $d->addEventListener(array(0 => 'prePersist', 1 => 'preUpdate', 2 => 'postLoad'), $this->get('mk.doctrine_media_listener'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'michelk9_sym_backend', 'user' => 'michelk9_root', 'password' => 'Ai}woqtZV4[V', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $d, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_bd31d08d73841c0ea098d387a27589b4c39c3cc3b04c68a220d2ff3f8d32a64b');
    ...
    {
        return $this->services['mk.api_exception_subscriber'] = new \MK\ApiBundle\EventListener\ApiExceptionSubscriber(true, $this->get('mk.api.response_factory'));
    }
