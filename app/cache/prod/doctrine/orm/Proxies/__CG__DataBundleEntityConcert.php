 ...
 */
class Concert extends \DataBundle\Entity\Concert implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'DataBundle\\Entity\\Concert' . "\0" . 'id', '' . "\0" . 'DataBundle\\Entity\\Concert' . "\0" . 'date', '' . "\0" . 'DataBundle\\Entity\\Concert' . "\0" . 'location', 'band');
        }
