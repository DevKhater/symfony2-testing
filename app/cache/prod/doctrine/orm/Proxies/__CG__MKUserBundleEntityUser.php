...
namespace Proxies\__CG__\MK\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \MK\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MK\\UserBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'MK\\UserBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'MK\\UserBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'MK\\UserBundle\\Entity\\User' . "\0" . 'salt', '' . "\0" . 'MK\\UserBundle\\Entity\\User' . "\0" . 'plainPassword', '' . "\0" . 'MK\\UserBundle\\Entity\\User' . "\0" . 'password', 'roles');
        }
