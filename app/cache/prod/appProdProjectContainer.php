...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'mk.api.response_factory' => 'getMk_Api_ResponseFactoryService',
            'mk.api_exception_subscriber' => 'getMk_ApiExceptionSubscriberService',
            'mk.doctrine_media_listener' => 'getMk_DoctrineMediaListenerService',
            'mk.jwt.authenticator' => 'getMk_Jwt_AuthenticatorService',
            'mk.login.form_authenticator' => 'getMk_Login_FormAuthenticatorService',
            'mk.user.manager' => 'getMk_User_ManagerService',
            'mk.user.password_encoder' => 'getMk_User_PasswordEncoderService',
            'mk.user.provider' => 'getMk_User_ProviderService',
            'mkcrud.file.uploader' => 'getMkcrud_File_UploaderService',
            ...
            'security.firewall.map.context.ng' => 'getSecurity_Firewall_Map_Context_NgService',
        ...
        $this->aliases = array(
            ...
            'security.user_checker.ng' => 'security.user_checker.main',
    ...
    protected function getCacheWarmerService()
    {
        ...
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('templating.locator')), 1 => $this->get('kernel.class_cache.cache_warmer'), 2 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TranslationsCacheWarmer($this->get('translator')), 3 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 4 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c, array(($this->targetDirs[2].'/../src/MK/UserBundle/Resources') => 'MKUserBundle', ($this->targetDirs[2].'/../src/DataBundle/Resources') => 'DataBundle')), 5 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheWarmer($this->get('twig'), new \Symfony\Bundle\TwigBundle\TemplateIterator($a, $this->targetDirs[2], array(($this->targetDirs[2].'/../src/MK/UserBundle/Resources') => 'MKUserBundle', ($this->targetDirs[2].'/../src/DataBundle/Resources') => 'DataBundle'))), 6 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine')), 7 => $this->get('fos_rest.allowed_methods_loader')));
    }
    ...
    /*
     * Gets the 'data.band.handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \DataBundle\Handler\BandHandler A DataBundle\Handler\BandHandler instance
     */
    protected function getData_Band_HandlerService()
    {
        return $this->services['data.band.handler'] = new \DataBundle\Handler\BandHandler($this->get('doctrine.orm.default_entity_manager'), 'DataBundle\\Entity\\Band', $this->get('form.factory'));
    }

    /*
     * Gets the 'data.concert.handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \DataBundle\Handler\ConcertHandler A DataBundle\Handler\ConcertHandler instance
     */
    ...
    /*
     * Gets the 'data.location.handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \DataBundle\Handler\LocationHandler A DataBundle\Handler\LocationHandler instance
     */
    protected function getData_Location_HandlerService()
    {
        return $this->services['data.location.handler'] = new \DataBundle\Handler\LocationHandler($this->get('doctrine.orm.default_entity_manager'), 'DataBundle\\Entity\\Location', $this->get('form.factory'));
    }

    /*
     * Gets the 'data.media.handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \DataBundle\Handler\MediaHandler A DataBundle\Handler\MediaHandler instance
     */
    protected function getData_Media_HandlerService()
    {
        return $this->services['data.media.handler'] = new \DataBundle\Handler\MediaHandler($this->get('doctrine.orm.default_entity_manager'), 'DataBundle\\Entity\\Media', $this->get('form.factory'), $this->get('mkcrud.file.uploader'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $b->addEventListener(array(0 => 'prePersist', 1 => 'preUpdate', 2 => 'postLoad'), $this->get('mk.doctrine_media_listener'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'michelk9_sym_backend', 'user' => 'michelk9_root', 'password' => 'Ai}woqtZV4[V', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $b, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/MK/UserBundle/Entity'), 1 => ($this->targetDirs[3].'/src/DataBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'MK\\UserBundle\\Entity');
        $c->addDriver($b, 'DataBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('MKUserBundle' => 'MK\\UserBundle\\Entity', 'DataBundle' => 'DataBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_1c953207a04d2b1d51c71aa3374c5d17a9f5c78eaae340438aa3daef1ae55910');
    ...
    protected function getFosRest_FormatNegotiatorService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api', NULL, NULL, NULL, array()), array('priorities' => array(0 => 'json', 1 => 'xml'), 'fallback_format' => NULL, 'prefer_extension' => '2.0', 'methods' => NULL, 'attributes' => array(), 'stop' => false));
        $instance->add($a, array('priorities' => array(0 => 'html', 1 => '*/*'), 'fallback_format' => 'html', 'prefer_extension' => '2.0', 'methods' => NULL, 'attributes' => array(), 'stop' => false));
        $instance->add($a, array('priorities' => array(0 => 'html', 1 => '*/*'), 'fallback_format' => 'html', 'prefer_extension' => '2.0', 'methods' => NULL, 'attributes' => array(), 'stop' => false));
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/doc/api', NULL, NULL, NULL, array()), array('priorities' => array(0 => 'html', 1 => '*/*'), 'fallback_format' => 'html', 'prefer_extension' => '2.0', 'methods' => NULL, 'attributes' => array(), 'stop' => false));
    ...
    {
        return $this->services['jms_serializer.datetime_handler'] = new \JMS\Serializer\Handler\DateHandler('Y-m-d\\TH:i:sO', 'CST6CDT', true);
    }
    ...
    {
        return $this->services['lexik_jwt_authentication.key_loader'] = new \Lexik\Bundle\JWTAuthenticationBundle\Services\KeyLoader\OpenSSLKeyLoader(($this->targetDirs[2].'/../var/jwt/private.pem'), ($this->targetDirs[2].'/../var/jwt/public.pem'), 'symfony2');
    }
    ...
    /*
     * Gets the 'mk.api.response_factory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MK\ApiBundle\Factory\ApiResponseFactory A MK\ApiBundle\Factory\ApiResponseFactory instance
     */
    protected function getMk_Api_ResponseFactoryService()
    {
        return $this->services['mk.api.response_factory'] = new \MK\ApiBundle\Factory\ApiResponseFactory();
    }

    /*
     * Gets the 'mk.api_exception_subscriber' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MK\ApiBundle\EventListener\ApiExceptionSubscriber A MK\ApiBundle\EventListener\ApiExceptionSubscriber instance
     */
    protected function getMk_ApiExceptionSubscriberService()
    {
        return $this->services['mk.api_exception_subscriber'] = new \MK\ApiBundle\EventListener\ApiExceptionSubscriber(false, $this->get('mk.api.response_factory'));
    }

    /*
     * Gets the 'mk.doctrine_media_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \DataBundle\EventListener\MediaUploadListener A DataBundle\EventListener\MediaUploadListener instance
     */
    protected function getMk_DoctrineMediaListenerService()
    {
        return $this->services['mk.doctrine_media_listener'] = new \DataBundle\EventListener\MediaUploadListener($this->get('mkcrud.file.uploader'));
    }

    /*
     * Gets the 'mk.jwt.authenticator' service.
     *
     * This service is autowired.
     *
     * @return \MK\ApiBundle\Security\Authenticator\JwtAuthenticator A MK\ApiBundle\Security\Authenticator\JwtAuthenticator instance
     */
    protected function getMk_Jwt_AuthenticatorService()
    {
        return $this->services['mk.jwt.authenticator'] = new \MK\ApiBundle\Security\Authenticator\JwtAuthenticator($this->get('doctrine.orm.default_entity_manager'), $this->get('lexik_jwt_authentication.encoder.default'), $this->get('mk.api.response_factory'));
    }

    /*
     * Gets the 'mk.login.form_authenticator' service.
     *
     * This service is autowired.
     *
     * @return \MK\UserBundle\Security\Authenticator\FormLoginAuthenticator A MK\UserBundle\Security\Authenticator\FormLoginAuthenticator instance
     */
    protected function getMk_Login_FormAuthenticatorService()
    {
        return $this->services['mk.login.form_authenticator'] = new \MK\UserBundle\Security\Authenticator\FormLoginAuthenticator($this);
    }

    /*
     * Gets the 'mk.user.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MK\UserBundle\Handler\UserHandler A MK\UserBundle\Handler\UserHandler instance
     */
    protected function getMk_User_ManagerService()
    {
        return $this->services['mk.user.manager'] = new \MK\UserBundle\Handler\UserHandler($this->get('doctrine.orm.default_entity_manager'), 'MK\\UserBundle\\Entity\\User', $this->get('security.password_encoder'));
    }

    /*
     * Gets the 'mk.user.password_encoder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MK\UserBundle\Security\Encoder\PasswordEncoder A MK\UserBundle\Security\Encoder\PasswordEncoder instance
     */
    protected function getMk_User_PasswordEncoderService()
    {
        return $this->services['mk.user.password_encoder'] = new \MK\UserBundle\Security\Encoder\PasswordEncoder();
    }

    /*
     * Gets the 'mk.user.provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MK\UserBundle\Security\Provider\UserProvider A MK\UserBundle\Security\Provider\UserProvider instance
     */
    protected function getMk_User_ProviderService()
    {
        return $this->services['mk.user.provider'] = new \MK\UserBundle\Security\Provider\UserProvider($this->get('doctrine.orm.default_entity_manager'));
    }

    /*
     * Gets the 'mkcrud.file.uploader' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \DataBundle\Service\FileUploader A DataBundle\Service\FileUploader instance
     */
    protected function getMkcrud_File_UploaderService()
    {
        return $this->services['mkcrud.file.uploader'] = new \DataBundle\Service\FileUploader(($this->targetDirs[2].'/../web/uploads/images'), 'uploads/images');
    }
    ...
    {
        return $this->services['nelmio_cors.options_provider.config'] = new \Nelmio\CorsBundle\Options\ConfigProvider(array('^/api/' => array('allow_origin' => true, 'allow_headers' => true, 'allow_methods' => array(0 => 'POST', 1 => 'PUT', 2 => 'GET', 3 => 'DELETE', 4 => 'OPTIONS'), 'max_age' => 3600), '^/login_check' => array('allow_origin' => true, 'allow_headers' => true, 'allow_methods' => array(0 => 'POST', 1 => 'PUT', 2 => 'GET', 3 => 'DELETE', 4 => 'OPTIONS'), 'max_age' => 3600), '^/login' => array('allow_origin' => true, 'allow_headers' => true, 'allow_methods' => array(0 => 'POST', 1 => 'PUT', 2 => 'GET', 3 => 'DELETE', 4 => 'OPTIONS'), 'max_age' => 3600)), array('allow_origin' => array(), 'allow_credentials' => false, 'allow_headers' => array(), 'expose_headers' => array(), 'allow_methods' => array(), 'max_age' => 0, 'hosts' => array(), 'origin_regex' => false));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('MK\\UserBundle\\Entity\\User' => $this->get('mk.user.password_encoder')));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('/'), 'security.firewall.map.context.api' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/'), 'security.firewall.map.context.ng' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/ng/'))), $this->get('event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_ApiService()
    {
        ...
        $b = $this->get('mk.jwt.authenticator');
        $c = $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE);
        $d = $this->get('security.token_storage');

        return $this->services['security.firewall.map.context.api'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener($this->get('security.authentication.guard_handler'), $a, 'api', array(0 => $b), $c), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($d, '5877ba9dbae100.58845027', $c, $a), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($d, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'api', $b, NULL, NULL, $c, true));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $e = $this->get('mk.login.form_authenticator');
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'paths' => array(($this->targetDirs[2].'/../src/MK/UserBundle/Resources') => 'MKUserBundle', ($this->targetDirs[2].'/../src/DataBundle/Resources') => 'DataBundle'), 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig'), 'autoescape' => 'name', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[2].'/../src/MK/UserBundle/Resources'), 'MKUserBundle');
        $instance->addPath(($this->targetDirs[2].'/../src/DataBundle/Resources'), 'DataBundle');
        ...
        $instance->addPath(($this->targetDirs[3].'/src/MK/UserBundle/Resources/views'), 'MKUser');
        $instance->addPath(($this->targetDirs[3].'/src/MK/ApiBundle/Resources/views'), 'MKApi');
        $instance->addPath(($this->targetDirs[3].'/src/DataBundle/Resources/views'), 'Data');
        $instance->addPath(($this->targetDirs[3].'/src/AngularBundle/Resources/views'), 'Angular');
    ...
    {
        return $this->services['jms_serializer.metadata.file_locator'] = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'/vendor/sensio/framework-extra-bundle/Resources/config/serializer'), 'Lexik\\Bundle\\JWTAuthenticationBundle' => ($this->targetDirs[3].'/vendor/lexik/jwt-authentication-bundle/Resources/config/serializer'), 'Stof\\DoctrineExtensionsBundle' => ($this->targetDirs[3].'/vendor/stof/doctrine-extensions-bundle/Resources/config/serializer'), 'Nelmio\\ApiDocBundle' => ($this->targetDirs[3].'/vendor/nelmio/api-doc-bundle/Nelmio/ApiDocBundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'Bazinga\\Bundle\\HateoasBundle' => ($this->targetDirs[3].'/vendor/willdurand/hateoas-bundle/Bazinga/Bundle/HateoasBundle/Resources/config/serializer'), 'Nelmio\\CorsBundle' => ($this->targetDirs[3].'/vendor/nelmio/cors-bundle/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/Resources/config/serializer'), 'FOS\\JsRoutingBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/jsrouting-bundle/Resources/config/serializer'), 'AppBundle' => ($this->targetDirs[3].'/src/AppBundle/Resources/config/serializer'), 'MK\\UserBundle' => ($this->targetDirs[3].'/src/MK/UserBundle/Resources/config/serializer'), 'MK\\ApiBundle' => ($this->targetDirs[3].'/src/MK/ApiBundle/Resources/config/serializer'), 'DataBundle' => ($this->targetDirs[3].'/src/DataBundle/Resources/config/serializer'), 'AngularBundle' => ($this->targetDirs[3].'/src/AngularBundle/Resources/config/serializer')));
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/ng/'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/', NULL, array(0 => 'GET')), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MKUserBundle' => 'MK\\UserBundle\\MKUserBundle',
                'MKApiBundle' => 'MK\\ApiBundle\\MKApiBundle',
                'DataBundle' => 'DataBundle\\DataBundle',
                'AngularBundle' => 'AngularBundle\\AngularBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appProdProjectContainer',
            'database_host' => 'localhost',
            'database_port' => 3306,
            'database_name' => 'michelk9_sym_backend',
            'database_user' => 'michelk9_root',
            'database_password' => 'Ai}woqtZV4[V',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'ThisTokenIsNotSoSecretChangeIt',
            'upload_directory' => ($this->targetDirs[2].'/../web/uploads/images'),
            ...
            'lexik_jwt_authentication.pass_phrase' => 'symfony2',
